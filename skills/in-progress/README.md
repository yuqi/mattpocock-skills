...
- **[migrate-spec-acceptance](./migrate-spec-acceptance/SKILL.md)**: Backfill stable acceptance identifiers and ticket mappings for a legacy local Markdown spec without changing requirement semantics. User-invoked.
